...
class ObserveCollectionCardsUseCase @Inject constructor(
    private val collectionRepository: CollectionRepository
) {
    operator fun invoke(collectionLocalId: Long): Flow<List<CollectionCardEntity>> {
        return collectionRepository.observeCollectionCards(collectionLocalId)
    }
}
