...
class ObserveAllOwnedCardsUseCase @Inject constructor(
    private val collectionRepository: CollectionRepository
) {
    operator fun invoke(userId: Long): Flow<List<CollectionCardEntity>> {
        return collectionRepository.observeAllUserCards(userId)
    }
}
