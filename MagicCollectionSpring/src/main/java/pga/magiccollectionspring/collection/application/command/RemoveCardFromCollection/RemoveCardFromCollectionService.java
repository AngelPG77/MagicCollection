...
@Service
public class RemoveCardFromCollectionService implements ICommandService<RemoveCardFromCollectionCommand, Void> {

    private final ICollectionRepository collectionRepository;
    private final IUserInternalService userInternalService;
    private final CurrentUserProvider currentUserProvider;

    public RemoveCardFromCollectionService(ICollectionRepository collectionRepository,
    ...
    @Override
    @Transactional
    public Void execute(RemoveCardFromCollectionCommand command) {
